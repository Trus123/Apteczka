...
<div class="w3-main" style="margin-left:250px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:20px" id="showcase">
    <h1 class="w3-jumbo"><b>Ile leku zażyjesz?</b></h1>
    <hr class="w3-round">
  </div>
  ...
  <div class="wrapper" style="margin:0 auto;">
    <div class="form-container">
       <div class="form-inner">
          ...
          <form method="POST" action="zazycie.php">
            
            <input type="hidden"  name="IDopakowania" value="<?php echo $_GET['ajdi']; ?>" readonly>
            <input type="hidden"  name="IDleku" value="<?php echo $_GET['ajdi2']; ?>" readonly>
            <input type="hidden"  name="kosztZaz" value="<?php echo $_GET['koszt']; ?>" readonly>

             <div class="field">
                <input type="text"  name="Nazwa" value="<?php echo $_GET['nazwa']; ?>" readonly>
             </div>
             <div class="field">
                <input type="number"  placeholder="Ilość" name="ilosc" min="0" max="<?php echo $_GET['ile']; ?>" required>
             </div>
             <div  class="field btn">
                <div class="btn-layer"></div>
                <input  type="submit" value="Zażyj">
             </div>
          </form>
